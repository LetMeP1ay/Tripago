...
export default function HotelButton({ label, isActive }: HotelButtonProprs) {
  return (
    <button
      className={
        `w-40 md:w-full mr-4 h-8 md:h-10 md:mb-6 rounded-[50px] md:rounded-md justify-center items-center flex p-3.5 font-medium transition-all duration-600 ease-in-out ` +
        (isActive
