      ...
      <div className="pt-[30px]">
        ...
        <div className="relative flex py-5 items-center">
          ...
          <span className="flex-shrink mx-4 text-gray-400">
            <h1>Denny{"'"}s Hobson Street</h1>
          </span>
          {/*Name*/}
          <div className="flex-grow border-t border-gray-400"></div>
        </div>
        <div className="flex overflow-x-auto space-x-[15px] w-screen px-[15px]">
          {" "}
          {/*Images*/}
          <div
            className={`${desktopImgSize} flex-shrink-0 rounded-[15px] justify-center items-center flex overflow-y-hidden`}
          >
            {" "}
            {/*Image Div*/}
            <img
              className="w-[175] h-[175]"
        ...
        <div>
          {" "}
          {/*Bio*/}
          <div className="justify-center items-between inline-flex flex-1 w-screen gap-[15px] px-[15px]">
            {" "}
            {/*Information*/}
            <div>
              {" "}
        ...
        <div className="justify-center items-between inline-flex flex-1 w-screen gap-[15px] px-[15px]">
          {" "}
          {/*Action Buttons*/}
          <div className="w-1/2 justify-between items-center inline-flex gap-[15px]">
            {" "}
            {/*Buttons (restricting to half the screen)*/}
            <div className="justify-between items-center inline-flex w-full gap-[15px]">
              {" "}
              {/*buttons list */}
              <div className="grow shrink basis-0 h-[33px] bg-[#ebebeb] rounded-[50px] justify-center items-center gap-2.5 flex">
