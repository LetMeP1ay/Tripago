...
export default function Stripe() {
  ...
  return (
    <div>
      <div className="text-center text-black text-4xl font-bold p-5">Payment</div>
      <div className="max-w-6xl mx-auto p-10 text-white border m-10 rounded-md bg-blue-500">
        <div className="mb-10">
          ...
          <div className={`transition-all duration-500 ease-in-out overflow-hidden ${showDetails ? 'max-h-96' : 'max-h-0'}`}>
